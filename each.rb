# As you complete each challenge, RUN THE CODE to ensure it works. 
# You can do this by:
  # a. Copy and pasting it into IRB
  # b. Running the file in your Terminal. 
  # You can do this by running `ruby <filepath>`. 
...
weather_options.each do |weather|
  puts "It is currently #{weather} outside."
end
